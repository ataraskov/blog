---
title: "Stick with an ugly solution"
date: 2023-08-10T09:52:30+02:00
draft: False
tags:
...
As Larry Tesler was saing: "every application has an inherent amount of complexity that cannot be removed or hidden". While Tesler's [Law of conservation of complexity](https://en.m.wikipedia.org/wiki/Law_of_conservation_of_complexity) is mostly used in UI/UX, it has something for a programmer as well (developers are users of their own code to some degree). In other words, sometimes there is just no elegent solution for a given problem. Yes it hurts, I know.
