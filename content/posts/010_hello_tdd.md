...
Let's check how it can be approached in a different way, in a world of test-driven development. How "Hello World" will look like in TDD? Code is availble on github [repo](https://github.com/ataraskov/blog/tree/main/examples/hello-tdd).
