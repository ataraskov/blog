...
date: 2023-06-08T06:28:18+02:00
draft: false
tags:
  - motivation
  - flow
---
No matter how much I love what I do, sooner or later my motivation drains to zero. There are myriad materials on the topic already, sure. But why not to add my own drop to the ocean :D.
...
* *Minimize distructions*: Managers and colleagues love to chat/email/meet/... all day long. Socialization is good, but who will work? Just mute all the notifications and pop-ups, including phone ([especially phone](https://www.ted.com/talks/tristan_harris_how_better_tech_could_protect_us_from_distraction)) every once in a while.
* *Track tasks and progress*: Who doesn't like some graphics and reports? And even for CLI nerds there are a few task tracking tools, my preffered one is [taskwarrior](https://github.com/ataraskov/task-dashboard).
